# Generated by Django 4.2 on 2025-04-29 14:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('pending', 'pending'), ('completed', 'completed'), ('processing', 'processing'), ('failed', 'Failed')], default='pending', max_length=10)),
