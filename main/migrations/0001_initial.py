# Generated by Django 4.2 on 2025-08-15 15:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('eur_balance', models.DecimalField(decimal_places=2, default=0.0, max_digits=15)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('utility_bill', cloudinary.models.CloudinaryField(blank=True, max_length=255, null=True, verbose_name='utility_bill')),
                ...
                ('otp', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='profile_otp', to='main.otp')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('transaction_type', models.CharField(blank=True, choices=[('deposit', 'deposit'), ('withdrawal', 'withdrawal'), ('transfer', 'transfer'), ('subscription', 'subscription')], max_length=20, null=True)),
                ('amount', models.DecimalField(decimal_places=2, max_digits=15)),
                ('status', models.CharField(blank=True, choices=[('pending', 'pending'), ('completed', 'completed'), ('processing', 'processing'), ('refunded', 'refunded'), ('failed', 'failed')], default='pending', max_length=10, null=True)),
                ('payment_type', models.CharField(blank=True, choices=[('debit', 'debit'), ('credit', 'credit')], max_length=10, null=True)),
                ...
                ('vt_request_id', models.CharField(blank=True, max_length=100, null=True)),
                ('description', models.TextField(default='')),
                ('reference_id', models.CharField(default=main.models.generate_unique_identifier, max_length=100, unique=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('otp', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='tx_otp', to='main.otp')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_created', models.DateTimeField(auto_now_add=True)),
                ('otp', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='security_otp', to='main.otp')),
                ('user', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'db_table': 'security',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('selfie', cloudinary.models.CloudinaryField(blank=True, max_length=255, null=True, verbose_name='selfie')),
